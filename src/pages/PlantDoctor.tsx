      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-16">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="relative">
                  ...
                  <img 
                    src="/lovable-uploads/5090e472-45e2-4dc2-b388-6cbf2f73ab20.png"
                    alt="Monstera plant before treatment - showing damaged and yellowing leaves"
                    className="w-full h-80 lg:h-96 object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <h3 className="text-xl font-bold mb-2">Severely Damaged Plant</h3>
                    <p className="text-sm opacity-90">
                      This Monstera was struggling with multiple issues including yellowing leaves and poor structural support
                    </p>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <img 
                    src="/lovable-uploads/0cd7e1d1-f0c2-4b95-8bb0-b76188510016.png"
                    alt="Monstera plant after treatment - healthy and well-structured"
                    className="w-full h-80 lg:h-96 object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <h3 className="text-xl font-bold mb-2">Fully Restored & Thriving</h3>
                    <p className="text-sm opacity-90">
                      After Nick's expert care, the plant shows vibrant green foliage and proper structural support
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 bg-gray-50">
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <h4 className="font-semibold mb-2">Problem Diagnosed</h4>
                    <p className="text-sm text-muted-foreground">
                      Multiple leaf damage, poor soil conditions, and inadequate structural support
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="bg-blue-100 p-3 rounded-lg mb-3 inline-block">
                    ...
                    <h4 className="font-semibold mb-2">Treatment Applied</h4>
                    <p className="text-sm text-muted-foreground">
                      Professional repotting, soil amendment, pruning, and proper support system installation
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="bg-green-100 p-3 rounded-lg mb-3 inline-block">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <h3 className="text-xl font-bold mb-2">Struggling Palm with Browning Tips</h3>
                    <p className="text-sm opacity-90">
                      This palm plant was showing stress with browning leaf tips and overall poor growth patterns
                    </p>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <h3 className="text-xl font-bold mb-2">Vibrant & Healthy Palm</h3>
                    <p className="text-sm opacity-90">
                      After Nick's treatment, the palm displays lush, healthy foliage with proper growth and no browning
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 bg-gray-50">
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <h4 className="font-semibold mb-2">Problem Diagnosed</h4>
                    <p className="text-sm text-muted-foreground">
                      Leaf tip burn from water quality issues, improper humidity levels, and nutrient deficiencies
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="bg-blue-100 p-3 rounded-lg mb-3 inline-block">
                    ...
                    <h4 className="font-semibold mb-2">Treatment Applied</h4>
                    <p className="text-sm text-muted-foreground">
                      Water quality improvement, humidity optimization, proper fertilization, and pruning of damaged fronds
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="bg-green-100 p-3 rounded-lg mb-3 inline-block">
                    ...
                    <h4 className="font-semibold mb-2">Result Achieved</h4>
                    <p className="text-sm text-muted-foreground">
                      Eliminated browning with healthy new growth and improved overall plant vitality and appearance
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Sixth Before/After Comparison - Fiddle Leaf Fig */}
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="grid lg:grid-cols-2 gap-0">
                {/* Before Image */}
                <div className="relative">
                  ...
                  <img 
                    src="/lovable-uploads/54465ae0-122d-46dd-b0a9-80ffe7493e0b.png"
                    alt="Fiddle leaf fig before treatment - showing sparse growth and poor structure"
                    className="w-full h-80 lg:h-96 object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <h3 className="text-xl font-bold mb-2">Sparse & Struggling Fiddle Leaf Fig</h3>
                    <p className="text-sm opacity-90">
                      This fiddle leaf fig was showing poor growth with sparse foliage and weak branching structure
                    </p>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <img 
                    src="/lovable-uploads/286015e9-74f5-487d-af3d-a40e9941d8c0.png"
                    alt="Fiddle leaf fig after treatment - showing full, healthy growth"
                    className="w-full h-80 lg:h-96 object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <h3 className="text-xl font-bold mb-2">Full & Flourishing Tree</h3>
                    <p className="text-sm opacity-90">
                      After Nick's expert care, the fiddle leaf fig displays dense, healthy foliage and strong tree structure
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 bg-gray-50">
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <h4 className="font-semibold mb-2">Problem Diagnosed</h4>
                    <p className="text-sm text-muted-foreground">
                      Poor branching structure, inadequate light conditions, and improper pruning leading to sparse growth
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="bg-blue-100 p-3 rounded-lg mb-3 inline-block">
                    ...
                    <h4 className="font-semibold mb-2">Treatment Applied</h4>
                    <p className="text-sm text-muted-foreground">
                      Strategic pruning, proper repotting, optimal positioning guidance, and growth enhancement techniques
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="bg-green-100 p-3 rounded-lg mb-3 inline-block">
                    ...
                    <h4 className="font-semibold mb-2">Result Achieved</h4>
                    <p className="text-sm text-muted-foreground">
                      Dramatic transformation into a full, tree-like structure with dense foliage and strong branching
                    </p>
                  </div>
                </div>
              </div>
